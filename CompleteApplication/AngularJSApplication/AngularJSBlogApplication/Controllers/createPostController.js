var createPostController = ["$rootScope", "$scope", "$http", "$location", "$sessionStorage", function ($rootScope, $scope, $http, $location, $sessionStorage) {
    ...
    $scope.createPost = function () {
        ...
        $http.post("../AngularJSBlogApplication/createPost", { post: JSON.stringify($scope.post) })
